...
<form action="{{route('prescription.update',$prescription->id)}}" method="post" class="update-form">
    @csrf
    @method('PATCH')
    ...
    <div class="form-group">
        ...
        <input type="text" name="appointment_id" id="appointment_id" value="{{$prescription->appointment_id}}">
    </div>

    <div class="form-group">
        <label for="doctor_id">doctor_id</label>
        <input type="text" name="doctor_id" id="doctor_id" value="{{$prescription->doctor_id}}">
    </div>

    <div class="form-group">
        <label for="patient_id">patient_id</label>
        <input type="text" name="patient_id" id="patient_id" value="{{$prescription->patient_id}}">
    </div>


    <div class="form-group">
        <label for="diagnosis">diagnosis</label>
        <input type="text" name="diagnosis" id="diagnosis" value="{{$prescription->diagnosis}}">
    </div>


    <div class="form-group">
        <label for="advice">advice</label>
        <input type="text" name="advice" class="form-control form-control-rounded" id="advice"   value="{{$prescription->advice}}">
    </div>
