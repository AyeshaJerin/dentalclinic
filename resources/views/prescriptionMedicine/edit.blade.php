...
<form action="{{route('prescriptionMedicine.update',$prescriptionMedicine->id)}}" method="post" class="update-form">
    @csrf
    @method('PATCH')
    ...
    <div class="form-group">
        ...
        <input type="text" name="dosage" id="dosage" value="{{$prescriptionMedicine->dosage}}">
    </div>


    <div class="form-group">
        <label for="frequency">frequency</label>
        <input type="text" name="frequency" id="frequency" value="{{$prescriptionMedicine->frequency}}">
    </div>


    <div class="form-group">
        <label for="duration">duration</label>
        <input type="text" name="duration" class="form-control form-control-rounded" id="duration"   value="{{$prescriptionMedicine->duration}}">
    </div>
    <div class="form-group">
        <label for="instructions">instructions</label>
        <input type="text" name="instructions" id="instructions" value="{{$prescriptionMedicine->instructions}}">
    </div>
